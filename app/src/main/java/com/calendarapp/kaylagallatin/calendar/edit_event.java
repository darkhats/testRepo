...
public class edit_event extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedStartDateButton = (Button) this.findViewById(R.id.selectedEditStartDate);
        ...
        save.setOnClickListener(new View.OnClickListener()
        {
            public void onClick(View v) {
                ...
                if (!startDateClicked || !endDateClicked || !startTimeClicked || !endTimeClicked) {
                    Toast toast = Toast.makeText(edit_event.this, "You forgot to set a time or a date! Please make sure those are set ", Toast.LENGTH_SHORT);
                    toast.show();
                } else {
                    ...
                    if (valid && startTimeClicked && endTimeClicked && startDateClicked && endDateClicked) {
                        saveEvent();
                        finish();
                    } else {
                        Toast toast = Toast.makeText(edit_event.this, "You're already busy during that time! Please choose another ", Toast.LENGTH_SHORT);
                        toast.show();
                    }
                }
            }
